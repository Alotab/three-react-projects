...
const Hero = () => {
  return (
    <>
      <h1>Coffee Tracking for Coffe <abbr title="An enthusisat or devotee">Fiends</abbr>!</h1>
      <div className="benefits-list">
        <h3 className="font-bolder">Try <span className="text-gradient">Coffiend</span> and start ...</h3>
